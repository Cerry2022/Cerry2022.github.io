import{_ as s,c as e,o as n,a4 as a}from"./chunks/framework.iZPUC10f.js";const _=JSON.parse('{"title":"使用 npm run docs:dev 开启 VitePress 本地服务器提示 Error: listen EACCES","description":"","frontmatter":{},"headers":[],"relativePath":"web-build/vitepress/debug/listen-EACCES.md","filePath":"web-build/vitepress/debug/listen-EACCES.md","lastUpdated":1711866294000}'),t={name:"web-build/vitepress/debug/listen-EACCES.md"},p=a(`<h1 id="使用-npm-run-docs-dev-开启-vitepress-本地服务器提示-error-listen-eacces" tabindex="-1">使用 <code>npm run docs:dev</code> 开启 VitePress 本地服务器提示 <code>Error: listen EACCES</code> <a class="header-anchor" href="#使用-npm-run-docs-dev-开启-vitepress-本地服务器提示-error-listen-eacces" aria-label="Permalink to &quot;使用 \`npm run docs:dev\` 开启 VitePress 本地服务器提示 \`Error: listen EACCES\`&quot;">​</a></h1><h2 id="问题" tabindex="-1">问题 <a class="header-anchor" href="#问题" aria-label="Permalink to &quot;问题&quot;">​</a></h2><p>想启动 VitePress 本地服务器，执行 <code>npm run docs:dev</code> 命令时，出现 <code>Error: listen EACCES</code>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>$ npm run docs:dev</span></span>
