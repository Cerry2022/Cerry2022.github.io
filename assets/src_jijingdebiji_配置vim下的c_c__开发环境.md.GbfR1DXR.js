import{_ as s,o as i,c as a,a7 as n}from"./chunks/framework.aD5PnCqb.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"src/jijingdebiji/配置vim下的c_c++开发环境.md","filePath":"src/jijingdebiji/配置vim下的c_c++开发环境.md","lastUpdated":1728542614000}'),l={name:"src/jijingdebiji/配置vim下的c_c++开发环境.md"},p=n(`<h2 id="vim-c-c-开发配置" tabindex="-1">Vim C/C++开发配置 <a class="header-anchor" href="#vim-c-c-开发配置" aria-label="Permalink to &quot;Vim C/C++开发配置&quot;">​</a></h2><h3 id="_1-基础准备" tabindex="-1">1.基础准备 <a class="header-anchor" href="#_1-基础准备" aria-label="Permalink to &quot;1.基础准备&quot;">​</a></h3><p>安装g++ <a href="https://so.csdn.net/so/search?q=gcc&amp;spm=1001.2101.3001.7020" target="_blank" rel="noreferrer">gcc</a> git cmake</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sudo</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> apt-get</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> g++</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> gcc</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> cmake</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> git</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>NoExtraConfDetected: No .ycm_extra_conf.py file detected, so no compile flags are available. Thus no semantic support for C/C++/ObjC...</span></span></code></pre></div>`,12),t=[p];function h(e,k,F,r,g,d){return i(),a("div",{"data-pagefind-body":!0},t)}const o=s(l,[["render",h]]);export{y as __pageData,o as default};
